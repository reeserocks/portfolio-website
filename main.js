...
const PROJECTS = [
  ...
  },
  {
    ...
    image: "images/projectCards/deepsealuminosity.webp",
  },
  {
    date: "Spring 2026",
    ...
    tags: ["design"],
    href: "uxResearch/",
    image: "images/projectCards/uxresearch.webp",
  },
  {
    date: "Fall 2024",
    ...
    image: "images/projectCards/heartlines.webp",
  },
  {
    date: "May 2025",
    category: "3D Art",
    ...
    image: "images/projectCards/crabchar.webp",
  },
];
...
const SOFTWARE_ICONS = {
  procreate: "images/SoftwareIcons/procreate.webp",
  maya: "images/SoftwareIcons/maya.webp",
  mudbox: "images/SoftwareIcons/mudbox.webp",
  zbrush: "images/SoftwareIcons/zbrush.webp",
  "substance painter": "images/SoftwareIcons/substancepainter.webp",
  marmoset: "images/SoftwareIcons/marmoset.webp",
  unreal: "images/SoftwareIcons/unreal.webp",
  unity: "images/SoftwareIcons/unity.webp",
  photoshop: "images/SoftwareIcons/photoshop.webp",
  "adobe photoshop": "images/SoftwareIcons/photoshop.webp",
  illustrator: "images/SoftwareIcons/illustrator.webp",
  "adobe illustrator": "images/SoftwareIcons/illustrator.webp",
  godot: "images/SoftwareIcons/godot.webp",
  "rpg maker": "images/SoftwareIcons/rpgmaker.webp",
  gimp: "images/SoftwareIcons/gimp.webp",
  mixamo: "images/SoftwareIcons/mixamo.webp",
  html: "images/SoftwareIcons/html.webp",
  ...
  if (filter === "all") {
    ...
    if (items.length >= ABOUT_ME_AFTER) {
      ...
      if (bottomItems.length > 0) {
        const group2 = createMasonryGroup(
          bottomItems,
          currentCols,
          ABOUT_ME_AFTER,
        );
    ...
    const filtered = items.filter((item) => item.categories.includes(filter));
...
function buildImageMedia(item, altText, eager = false) {
  ...
  if (item.href) {
    ...
    wrapper.addEventListener("click", () =>
      openLightbox(item.image, item.paragraph),
    );
  }
  return wrapper;
}
...
function closeLightbox() {
  ...
  lb.addEventListener("transitionend", () => lb.classList.add("hidden"), {
    once: true,
  });
}
